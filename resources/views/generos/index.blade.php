        ...
        <div style="display: flex; justify-content: space-between; align-items: center;">
                <span id="card_title">{{ __('Generos') }}</span>
                    ...
                    <div class="float-right">
                        <a href="{{ route('generos.create') }}" class="btn btn-dark me-3 float-right"  data-placement="left">
                        {{ __('Create New') }}</a>
                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    <a href="{{ route('generos.edit', $genero->id) }}" class="btn btn-sm btn-info me-4">Editar</a>
