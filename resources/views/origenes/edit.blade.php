            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <form method="POST" action="{{ route('origenes.update', $origen->id) }}">
                        ...
                        <div class="mb-3">
                            <label for="pais" class="form-label">Nombre</label>
                            <input type="text" name="pais" id="pais" value="{{ old('pais', $origen->pais) }}" class="form-control @error('pais') is-invalid @enderror" required>
                            @error('descripcion')
