...
<body>
    ...
    <div class="card-header"> 
        <div style="display: flex; justify-content: space-between; align-items: center;">
                <span id="card_title">{{ __('Origenes de marcas') }}</span>
        
                    <div class="float-right">
                        <a href="{{ route('marcas.create') }}" class="btn btn-dark me-3 float-right"  data-placement="left">
                        {{ __('Create New') }}</a>
                    </div>
                        ...
                        <tr id="demo">
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    <a href="{{ route('origenes.edit', $origen->id) }}" class="btn btn-sm btn-info me-2 p-1 float-right">Editar</a>
                                    <br>
                                    <button type="button" class="btn btn-sm btn-danger me-2 p-1 float-left" onclick="confirmDelete('{{ $origen->id }}')">Eliminar</button>
                                </div>
                            </td>
                        </tr>
                    @endforeach
