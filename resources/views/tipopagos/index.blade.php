...
<body>
    ...
    <div class="card-header"> 
        <div style="display: flex; justify-content: space-between; align-items: center;">
                <span id="card_title">{{ __('Tipo pagos') }}</span>
            
                    <div class="float-right">
                        <a href="{{ route('tipopagos.create') }}" class="btn btn-dark me-3 float-right"  data-placement="left">
                        {{ __('Create New') }}</a>
                    </div>
                        ...
                        <tr id='demo'>
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    <a href="{{ route('tipopagos.edit', $tipopago->id) }}" class="btn btn-sm btn-info me-4">Editar</a>
