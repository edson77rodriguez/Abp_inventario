                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('colors.update', $color->id) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="descripcion" id="descripcion" value="{{ old('descripcion', $color->descripcion) }}" class="form-control @error('descripcion') is-invalid @enderror" required>
                            @error('descripcion')
