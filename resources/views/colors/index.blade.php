...
<body>
    ...
    <main class="container">
        ...
        <h2 class="text-center mb-4">Lista de colores</h2>
        <div class="mb-3 text-end">
        <a href="{{ route('colors.create') }}" class="btn btn-dark text-white">+ color </a>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    <a href="{{ route('colors.edit', $color->id) }}" class="btn btn-sm btn-info me-4">Editar</a>
