                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('tallas.update', $talla->id) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="descripcion" id="descripcion" value="{{ old('descripcion', $talla->descripcion) }}" class="form-control @error('descripcion') is-invalid @enderror" required>
                            @error('descripcion')
