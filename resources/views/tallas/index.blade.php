    ...
    <div class="row">
        @foreach ($tallas as $talla)
            <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title text-center">{{ $talla->descripcion}}</h5>
                        <p class="card-text"><strong>Id:</strong> {{ $talla->id }}</p>
                        <p class="card-text"><strong>Talla:</strong> {{ $talla->descripcion}}</p>
                        
                        <div class="d-flex justify-content-between">
                        <button class="btn btn-info me-2 p-1" data-bs-toggle="modal" data-bs-target="#viewTallaModal{{ $talla->id }}">Ver</button>
                            <button class="btn btn-primary me-2 p-1" data-bs-toggle="modal" data-bs-target="#editTallaModal{{ $talla->id }}">Editar</button>
